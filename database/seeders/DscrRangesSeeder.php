...
class DscrRangesSeeder extends Seeder
{
    public function run(): void
    {
        $dscrRanges = [
            ...
            ['dscr_range' => '1.10-1.20', 'min_dscr' => 1.10, 'max_dscr' => 1.19, 'display_order' => 2],
            ['dscr_range' => '1.00-1.09x', 'min_dscr' => 1.00, 'max_dscr' => 1.09, 'display_order' => 3],
            ['dscr_range' => '0.80-0.99x', 'min_dscr' => 0.80, 'max_dscr' => 0.99, 'display_order' => 4],
        ];
